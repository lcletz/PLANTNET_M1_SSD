...
# 1. Charger les la première moitié des données expertes
...
print(f"Quantile à {confidence*100:.0f}% basé sur les non-experts (score s1) : {quantile2:.4f}")
...
df["Conforme"] = df["Score_s1"] <= quantile2
