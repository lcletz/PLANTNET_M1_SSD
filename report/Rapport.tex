...
\begin{figure}[htbp]
    \centering
    \includesvg[width=0.46\textwidth]{images/graphique_methode1}\hfill
    \includesvg[width=0.46\textwidth]{images/graphique_methode2}
    \caption{Graphiques des deux premières configurations}
    \label{fig:graphiques_methode1_methode2}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includesvg[width=0.46\textwidth]{images/graphique_methode3}\hfill
    \includesvg[width=0.46\textwidth]{images/graphique_methode4}
    \caption{Graphiques des deux dernières configurations}
    \label{fig:graphiques_methode3_methode4}
\end{figure}

Analysons le \autoref{tab: scores et quantiles} ainsi que les \autoref{fig:graphiques_methode1_methode2} et \autoref{fig:graphiques_methode3_methode4} associés :

\vspace{0.2cm}

Le tableau met en évidence les quantiles obtenus selon différentes configurations :
\begin{itemize}
    \item \textbf{Score s1 + données non expertes :} quantile le plus élevé ($0,9990$), traduisant une approche plus permissive.
    \item \textbf{Score s1 + données expertes :} quantile de $0,9649$, témoignant d’une amélioration en termes de sélectivité.
    \item \textbf{Score s2 + données non expertes :} $0,7538$, soit une baisse significative du quantile.
    \item \textbf{Score s2 + données expertes :} $0,5614$, ce qui indique une approche plus stricte, réduisant les incertitudes.
\end{itemize}
...
Les \autoref{fig:graphiques_methode1_methode2} et \autoref{fig:graphiques_methode3_methode4} illustrent la répartition des observations testées selon les scores s1 et s2, en distinguant les données expertes et non expertes.\\
