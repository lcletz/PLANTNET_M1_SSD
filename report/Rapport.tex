...
Ces deux graphes, comptant chacun $\num{2000}$ observations sélectionnées aléatoirement, révèlent plusieurs phénomènes intéressants.
...
\begin{itemize}
    \item \textbf{Score s1 + données non expertes :} quantile le plus élevé ($0,9990$), traduisant une approche plus permissive qui conserve presque toutes les observations (mis à part celles pour lesquelles nous avons attribuée un score de $0,001$ car elles n'avaient pas la bonne étiquette de proposée).
